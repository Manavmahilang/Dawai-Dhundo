...
const Navbar = async () => {
  ...
  return (
    <div className='fixed backdrop-blur-sm bg-white/75 dark:bg-slate-900/75 z-50 top-0 left-0 right-0 h-20 border-b border-slate-300 dark:border-slate-700 shadow-sm flex items-center justify-center'>
      <div className='container max-w-7xl mx-auto w-full flex justify-between items-center justify-evenly'>
  ...
  <ThemeToggle />*/}
        ...
        <div className='hidden md:flex gap-4'>
          ...
          >
            ...
            text-white text-[10px] md:text-[15px] flex justify-center items-center px-[2px] md:px-[5px]'>5
              </div>
            </div>
          </Link>
          {session ? (
